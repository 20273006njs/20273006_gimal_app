...
public class MainActivity extends AppCompatActivity {
    ...
    public void InitalLizelistenner()
    {
        callbackMethon=new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int year, int month, int dayOfMonth) {
                ...
                editText.setText("http://www.kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=6ec28241a621a545bafb93f2b4588dd9&targetDt="+ date);
    ...
    {
        DatePickerDialog dialog = new DatePickerDialog(this,callbackMethon,2021,11,13);
        dialog.show();
    }
